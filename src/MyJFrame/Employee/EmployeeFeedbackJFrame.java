...
public class EmployeeFeedbackJFrame extends JFrame{
    ...
    public EmployeeFeedbackJFrame()  {
        super("EmployeeFeedbackJFrame");
        setSize(1100, 660);
    ...
    public void showComponentIni () {
        ...
        searchJButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //更新表格
                feedbackTable.setModel(new DefaultTableModel(getFeedbackData(searchFeedback), new String[]{"编号","名称", "用户", "时间" , "内容","状态"}));
            }
        });
        searchFeedback.setStaffid(LoginJFrame.currentUser.getId());
        DefaultTableModel productmodel = new DefaultTableModel(getFeedbackData(searchFeedback), new String[]{"编号","名称", "用户", "时间" , "内容","状态"});
